...
## Architecture notes
- The GDB script **monkey-patches** `pwndbg.gdblib.symbol.get` (or `pwndbg.symbol.get`) to intercept symbol resolution and inject renamed symbols. This is the core mechanism.
